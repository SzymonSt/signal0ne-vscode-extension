  ...
  <body>
    ...
    <div class="icons-container">
        <div class="likes-container">
            <svg id="score-positive" class="${issue.score === 1 ? 'bi bi-hand-thumbs-up d-flex align-items-center justify-content-center like score-selected' : 'bi bi-hand-thumbs-up d-flex align-items-center justify-content-center like'}" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" viewBox="0 0 16 16">
            ...
            <svg id="score-negative" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" class="${issue.score === -1 ? 'bi bi-hand-thumbs-up d-flex align-items-center justify-content-center like score-selected' : 'bi bi-hand-thumbs-up d-flex align-items-center justify-content-center like'}">
        ...
        <span class="hover-text mr-10">
            <button id="resolve-button" class="${issue.isResolved ? 'btn btn-secondary reload-button resolved' : 'btn btn-secondary reload-button'}">
...
const generateSourcesLinks = (issue: any) => {
  if (issue.issuePredictedSolutionsSources?.length) {
    return issue.issuePredictedSolutionsSources.map((link: string) => {
      return `<a class="source-link" target="blank" href="${link}">${link}</a>`;
    }).join('');
  } else {
    return '';

...
exports.PaymentSuccessComponent = void 0;
...
let PaymentSuccessComponent = (() => {
    ...
    let _classThis;
    var PaymentSuccessComponent = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            PaymentSuccessComponent = _classThis = _classDescriptor.value;
            if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
            __runInitializers(_classThis, _classExtraInitializers);
        }
        activatedRoute;
        router;
        versionsUpdateService;
        toastrService;
        translateService;
        authStateService;
        sessionId;
        constructor(activatedRoute, router, versionsUpdateService, toastrService, translateService, authStateService) {
            this.activatedRoute = activatedRoute;
            this.router = router;
            this.versionsUpdateService = versionsUpdateService;
    ...
    return PaymentSuccessComponent = _classThis;
})();

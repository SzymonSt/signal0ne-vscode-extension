...
let ErrorHandlerInterceptor = (() => {
    let _classDecorators = [(0, core_1.Injectable)()];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var ErrorHandlerInterceptor = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            ErrorHandlerInterceptor = _classThis = _classDescriptor.value;
        ...
        translateService;
        authStateService;
        constructor(toastrService, translateService, authStateService) {
        ...
        intercept(req, next) {
            if (!req.url.includes('token/refresh')) {
                return next.handle(req).pipe((0, rxjs_1.catchError)((err) => {
    ...
    return ErrorHandlerInterceptor = _classThis;
})();
